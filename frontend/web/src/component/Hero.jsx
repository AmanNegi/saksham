...
const Hero = () => {
	return (
		<section className="h-[100vh] text-white relative bg-black">
			<div className="absolute top-[50vh] mt-[4px] md:top-[25vh]  md:left-[10vw]">
				<div className="font-bold mb-4 text-center text-[1.5rem] sm:text-[3rem] text-center">
					Saksham App
				</div>
				...
				<img className="h-[75px] mt-4 absolute left-[11vh]" src="/google.png" alt="" />
			</div>
