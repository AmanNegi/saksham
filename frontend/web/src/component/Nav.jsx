		...
		<nav className="relative z-10 w-full bg-transparent border-gray-200">
			<div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
				...
				<div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
					<button
						type="button"
						className="text-white bg-[#3498DA]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center hover:bg-blue-600">
						Download now
					</button>
					<button
